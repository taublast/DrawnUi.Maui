...
{
    public class LegacyGesturesBoxView : Microsoft.Maui.Controls.BoxView, IWithTouch, AppoMobi.Maui.Gestures.IGestureListener
    {
        #region MODERN

        static void GesturesChanged(BindableObject bindable, object oldvalue, object newvalue)
        {
            if (bindable is LegacyGesturesBoxView control)
            {
        ...
        static LegacyGesturesBoxView()
        {
            LegacyGesturesBoxView.DownCommandProperty = GestureHandler.DownCommandProperty;
            LegacyGesturesBoxView.DownCommandParameterProperty = GestureHandler.DownCommandParameterProperty;
            LegacyGesturesBoxView.UpCommandProperty = GestureHandler.UpCommandProperty;
            LegacyGesturesBoxView.UpCommandParameterProperty = GestureHandler.UpCommandParameterProperty;
            LegacyGesturesBoxView.TappingCommandProperty = GestureHandler.TappingCommandProperty;
            LegacyGesturesBoxView.TappingCommandParameterProperty = GestureHandler.TappingCommandParameterProperty;
            LegacyGesturesBoxView.TappedCommandProperty = GestureHandler.TappedCommandProperty;
            LegacyGesturesBoxView.TappedCommandParameterProperty = GestureHandler.TappedCommandParameterProperty;
            LegacyGesturesBoxView.DoubleTappedCommandProperty = GestureHandler.DoubleTappedCommandProperty;
            LegacyGesturesBoxView.DoubleTappedCommandParameterProperty = GestureHandler.DoubleTappedCommandParameterProperty;
            LegacyGesturesBoxView.LongPressingCommandProperty = GestureHandler.LongPressingCommandProperty;
            LegacyGesturesBoxView.LongPressingCommandParameterProperty = GestureHandler.LongPressingCommandParameterProperty;
            LegacyGesturesBoxView.LongPressedCommandProperty = GestureHandler.LongPressedCommandProperty;
            LegacyGesturesBoxView.LongPressedCommandParameterProperty = GestureHandler.LongPressedCommandParameterProperty;
            LegacyGesturesBoxView.PinchingCommandProperty = GestureHandler.PinchingCommandProperty;
            LegacyGesturesBoxView.PinchingCommandParameterProperty = GestureHandler.PinchingCommandParameterProperty;
            LegacyGesturesBoxView.PinchedCommandProperty = GestureHandler.PinchedCommandProperty;
            LegacyGesturesBoxView.PinchedCommandParameterProperty = GestureHandler.PinchedCommandParameterProperty;
            LegacyGesturesBoxView.PanningCommandProperty = GestureHandler.PanningCommandProperty;
            LegacyGesturesBoxView.PanningCommandParameterProperty = GestureHandler.PanningCommandParameterProperty;
            LegacyGesturesBoxView.PannedCommandProperty = GestureHandler.PannedCommandProperty;
            LegacyGesturesBoxView.PannedCommandParameterProperty = GestureHandler.PannedCommandParameterProperty;
            LegacyGesturesBoxView.SwipedCommandProperty = GestureHandler.SwipedCommandProperty;
            LegacyGesturesBoxView.SwipedCommandParameterProperty = GestureHandler.SwipedCommandParameterProperty;
            LegacyGesturesBoxView.RotatingCommandProperty = GestureHandler.RotatingCommandProperty;
            LegacyGesturesBoxView.RotatingCommandParameterProperty = GestureHandler.RotatingCommandParameterProperty;
            LegacyGesturesBoxView.RotatedCommandProperty = GestureHandler.RotatedCommandProperty;
            LegacyGesturesBoxView.RotatedCommandParameterProperty = GestureHandler.RotatedCommandParameterProperty;
        }
