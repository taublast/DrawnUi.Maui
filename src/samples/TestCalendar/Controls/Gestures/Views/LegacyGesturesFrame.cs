...
{
    public class LegacyGesturesFrame : Microsoft.Maui.Controls.Border, IWithTouch, AppoMobi.Maui.Gestures.IGestureListener
    {

        public LegacyGesturesFrame()
        {
            //StrokeThickness = 1;
            //Padding = 0;
            //Stroke = Brush.Gray;
        ...
        {
            if (bindable is LegacyGesturesFrame control)
            {
        ...
        static LegacyGesturesFrame()
        {
            AppoMobi.Touch.LegacyGesturesFrame.DownCommandProperty = AppoMobi.Touch.GestureHandler.DownCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.DownCommandParameterProperty = AppoMobi.Touch.GestureHandler.DownCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.UpCommandProperty = AppoMobi.Touch.GestureHandler.UpCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.UpCommandParameterProperty = AppoMobi.Touch.GestureHandler.UpCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.TappingCommandProperty = AppoMobi.Touch.GestureHandler.TappingCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.TappingCommandParameterProperty = AppoMobi.Touch.GestureHandler.TappingCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.TappedCommandProperty = AppoMobi.Touch.GestureHandler.TappedCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.TappedCommandParameterProperty = AppoMobi.Touch.GestureHandler.TappedCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.DoubleTappedCommandProperty = AppoMobi.Touch.GestureHandler.DoubleTappedCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.DoubleTappedCommandParameterProperty = AppoMobi.Touch.GestureHandler.DoubleTappedCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.LongPressingCommandProperty = AppoMobi.Touch.GestureHandler.LongPressingCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.LongPressingCommandParameterProperty = AppoMobi.Touch.GestureHandler.LongPressingCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.LongPressedCommandProperty = AppoMobi.Touch.GestureHandler.LongPressedCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.LongPressedCommandParameterProperty = AppoMobi.Touch.GestureHandler.LongPressedCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.PinchingCommandProperty = AppoMobi.Touch.GestureHandler.PinchingCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.PinchingCommandParameterProperty = AppoMobi.Touch.GestureHandler.PinchingCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.PinchedCommandProperty = AppoMobi.Touch.GestureHandler.PinchedCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.PinchedCommandParameterProperty = AppoMobi.Touch.GestureHandler.PinchedCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.PanningCommandProperty = AppoMobi.Touch.GestureHandler.PanningCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.PanningCommandParameterProperty = AppoMobi.Touch.GestureHandler.PanningCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.PannedCommandProperty = AppoMobi.Touch.GestureHandler.PannedCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.PannedCommandParameterProperty = AppoMobi.Touch.GestureHandler.PannedCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.SwipedCommandProperty = AppoMobi.Touch.GestureHandler.SwipedCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.SwipedCommandParameterProperty = AppoMobi.Touch.GestureHandler.SwipedCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.RotatingCommandProperty = AppoMobi.Touch.GestureHandler.RotatingCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.RotatingCommandParameterProperty = AppoMobi.Touch.GestureHandler.RotatingCommandParameterProperty;
            AppoMobi.Touch.LegacyGesturesFrame.RotatedCommandProperty = AppoMobi.Touch.GestureHandler.RotatedCommandProperty;
            AppoMobi.Touch.LegacyGesturesFrame.RotatedCommandParameterProperty = AppoMobi.Touch.GestureHandler.RotatedCommandParameterProperty;
        }
