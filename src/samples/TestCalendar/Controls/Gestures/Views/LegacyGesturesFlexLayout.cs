...
{
    public class LegacyGesturesFlexLayout : Microsoft.Maui.Controls.FlexLayout, IWithTouch, AppoMobi.Maui.Gestures.IGestureListener
    {
        #region MODERN

        static void GesturesChanged(BindableObject bindable, object oldvalue, object newvalue)
        {
            if (bindable is LegacyGesturesFlexLayout control)
            {
        ...
        public static readonly BindableProperty GesturesProperty = BindableProperty.Create(
            nameof(GesturesMode),
            typeof(GesturesMode),
            typeof(LegacyGesturesFlexLayout),
        ...
        static LegacyGesturesFlexLayout()
        {
            LegacyGesturesFlexLayout.DownCommandProperty = GestureHandler.DownCommandProperty;
            LegacyGesturesFlexLayout.DownCommandParameterProperty = GestureHandler.DownCommandParameterProperty;
            LegacyGesturesFlexLayout.UpCommandProperty = GestureHandler.UpCommandProperty;
            LegacyGesturesFlexLayout.UpCommandParameterProperty = GestureHandler.UpCommandParameterProperty;
            LegacyGesturesFlexLayout.TappingCommandProperty = GestureHandler.TappingCommandProperty;
            LegacyGesturesFlexLayout.TappingCommandParameterProperty = GestureHandler.TappingCommandParameterProperty;
            LegacyGesturesFlexLayout.TappedCommandProperty = GestureHandler.TappedCommandProperty;
            LegacyGesturesFlexLayout.TappedCommandParameterProperty = GestureHandler.TappedCommandParameterProperty;
            LegacyGesturesFlexLayout.DoubleTappedCommandProperty = GestureHandler.DoubleTappedCommandProperty;
            LegacyGesturesFlexLayout.DoubleTappedCommandParameterProperty = GestureHandler.DoubleTappedCommandParameterProperty;
            LegacyGesturesFlexLayout.LongPressingCommandProperty = GestureHandler.LongPressingCommandProperty;
            LegacyGesturesFlexLayout.LongPressingCommandParameterProperty = GestureHandler.LongPressingCommandParameterProperty;
            LegacyGesturesFlexLayout.LongPressedCommandProperty = GestureHandler.LongPressedCommandProperty;
            LegacyGesturesFlexLayout.LongPressedCommandParameterProperty = GestureHandler.LongPressedCommandParameterProperty;
            LegacyGesturesFlexLayout.PinchingCommandProperty = GestureHandler.PinchingCommandProperty;
            LegacyGesturesFlexLayout.PinchingCommandParameterProperty = GestureHandler.PinchingCommandParameterProperty;
            LegacyGesturesFlexLayout.PinchedCommandProperty = GestureHandler.PinchedCommandProperty;
            LegacyGesturesFlexLayout.PinchedCommandParameterProperty = GestureHandler.PinchedCommandParameterProperty;
            LegacyGesturesFlexLayout.PanningCommandProperty = GestureHandler.PanningCommandProperty;
            LegacyGesturesFlexLayout.PanningCommandParameterProperty = GestureHandler.PanningCommandParameterProperty;
            LegacyGesturesFlexLayout.PannedCommandProperty = GestureHandler.PannedCommandProperty;
            LegacyGesturesFlexLayout.PannedCommandParameterProperty = GestureHandler.PannedCommandParameterProperty;
            LegacyGesturesFlexLayout.SwipedCommandProperty = GestureHandler.SwipedCommandProperty;
            LegacyGesturesFlexLayout.SwipedCommandParameterProperty = GestureHandler.SwipedCommandParameterProperty;
            LegacyGesturesFlexLayout.RotatingCommandProperty = GestureHandler.RotatingCommandProperty;
            LegacyGesturesFlexLayout.RotatingCommandParameterProperty = GestureHandler.RotatingCommandParameterProperty;
            LegacyGesturesFlexLayout.RotatedCommandProperty = GestureHandler.RotatedCommandProperty;
            LegacyGesturesFlexLayout.RotatedCommandParameterProperty = GestureHandler.RotatedCommandParameterProperty;
        }
