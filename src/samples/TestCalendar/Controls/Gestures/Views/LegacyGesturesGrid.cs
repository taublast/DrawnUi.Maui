...
namespace AppoMobi.Touch
{
    ...
    public class LegacyGesturesGrid : Microsoft.Maui.Controls.Grid, IWithTouch, AppoMobi.Maui.Gestures.IGestureListener
    {
        ...
        {
            if (bindable is LegacyGesturesGrid control)
            {
        ...
        static LegacyGesturesGrid()
        {
            LegacyGesturesGrid.DownCommandProperty = GestureHandler.DownCommandProperty;
            LegacyGesturesGrid.DownCommandParameterProperty = GestureHandler.DownCommandParameterProperty;
            LegacyGesturesGrid.UpCommandProperty = GestureHandler.UpCommandProperty;
            LegacyGesturesGrid.UpCommandParameterProperty = GestureHandler.UpCommandParameterProperty;
            LegacyGesturesGrid.TappingCommandProperty = GestureHandler.TappingCommandProperty;
            LegacyGesturesGrid.TappingCommandParameterProperty = GestureHandler.TappingCommandParameterProperty;
            LegacyGesturesGrid.TappedCommandProperty = GestureHandler.TappedCommandProperty;
            LegacyGesturesGrid.TappedCommandParameterProperty = GestureHandler.TappedCommandParameterProperty;
            LegacyGesturesGrid.DoubleTappedCommandProperty = GestureHandler.DoubleTappedCommandProperty;
            LegacyGesturesGrid.DoubleTappedCommandParameterProperty = GestureHandler.DoubleTappedCommandParameterProperty;
            LegacyGesturesGrid.LongPressingCommandProperty = GestureHandler.LongPressingCommandProperty;
            LegacyGesturesGrid.LongPressingCommandParameterProperty = GestureHandler.LongPressingCommandParameterProperty;
            LegacyGesturesGrid.LongPressedCommandProperty = GestureHandler.LongPressedCommandProperty;
            LegacyGesturesGrid.LongPressedCommandParameterProperty = GestureHandler.LongPressedCommandParameterProperty;
            LegacyGesturesGrid.PinchingCommandProperty = GestureHandler.PinchingCommandProperty;
            LegacyGesturesGrid.PinchingCommandParameterProperty = GestureHandler.PinchingCommandParameterProperty;
            LegacyGesturesGrid.PinchedCommandProperty = GestureHandler.PinchedCommandProperty;
            LegacyGesturesGrid.PinchedCommandParameterProperty = GestureHandler.PinchedCommandParameterProperty;
            LegacyGesturesGrid.PanningCommandProperty = GestureHandler.PanningCommandProperty;
            LegacyGesturesGrid.PanningCommandParameterProperty = GestureHandler.PanningCommandParameterProperty;
            LegacyGesturesGrid.PannedCommandProperty = GestureHandler.PannedCommandProperty;
            LegacyGesturesGrid.PannedCommandParameterProperty = GestureHandler.PannedCommandParameterProperty;
            LegacyGesturesGrid.SwipedCommandProperty = GestureHandler.SwipedCommandProperty;
            LegacyGesturesGrid.SwipedCommandParameterProperty = GestureHandler.SwipedCommandParameterProperty;
            LegacyGesturesGrid.RotatingCommandProperty = GestureHandler.RotatingCommandProperty;
            LegacyGesturesGrid.RotatingCommandParameterProperty = GestureHandler.RotatingCommandParameterProperty;
            LegacyGesturesGrid.RotatedCommandProperty = GestureHandler.RotatedCommandProperty;
            LegacyGesturesGrid.RotatedCommandParameterProperty = GestureHandler.RotatedCommandParameterProperty;
        }
