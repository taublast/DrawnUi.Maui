...
{
	public class LegacyGesturesContentView : Microsoft.Maui.Controls.ContentView, IWithTouch, AppoMobi.Maui.Gestures.IGestureListener
    {
        #region MODERN

        static void GesturesChanged(BindableObject bindable, object oldvalue, object newvalue)
        {
            if (bindable is LegacyGesturesContentView control)
            {
        ...
        public static readonly BindableProperty GesturesProperty = BindableProperty.Create(
            nameof(GesturesMode),
            typeof(GesturesMode),
            typeof(LegacyGesturesContentView),
		...
		static LegacyGesturesContentView()
		{
			AppoMobi.Touch.LegacyGesturesContentView.DownCommandProperty = AppoMobi.Touch.GestureHandler.DownCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.DownCommandParameterProperty = AppoMobi.Touch.GestureHandler.DownCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.UpCommandProperty = AppoMobi.Touch.GestureHandler.UpCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.UpCommandParameterProperty = AppoMobi.Touch.GestureHandler.UpCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.TappingCommandProperty = AppoMobi.Touch.GestureHandler.TappingCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.TappingCommandParameterProperty = AppoMobi.Touch.GestureHandler.TappingCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.TappedCommandProperty = AppoMobi.Touch.GestureHandler.TappedCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.TappedCommandParameterProperty = AppoMobi.Touch.GestureHandler.TappedCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.DoubleTappedCommandProperty = AppoMobi.Touch.GestureHandler.DoubleTappedCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.DoubleTappedCommandParameterProperty = AppoMobi.Touch.GestureHandler.DoubleTappedCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.LongPressingCommandProperty = AppoMobi.Touch.GestureHandler.LongPressingCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.LongPressingCommandParameterProperty = AppoMobi.Touch.GestureHandler.LongPressingCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.LongPressedCommandProperty = AppoMobi.Touch.GestureHandler.LongPressedCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.LongPressedCommandParameterProperty = AppoMobi.Touch.GestureHandler.LongPressedCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.PinchingCommandProperty = AppoMobi.Touch.GestureHandler.PinchingCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.PinchingCommandParameterProperty = AppoMobi.Touch.GestureHandler.PinchingCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.PinchedCommandProperty = AppoMobi.Touch.GestureHandler.PinchedCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.PinchedCommandParameterProperty = AppoMobi.Touch.GestureHandler.PinchedCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.PanningCommandProperty = AppoMobi.Touch.GestureHandler.PanningCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.PanningCommandParameterProperty = AppoMobi.Touch.GestureHandler.PanningCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.PannedCommandProperty = AppoMobi.Touch.GestureHandler.PannedCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.PannedCommandParameterProperty = AppoMobi.Touch.GestureHandler.PannedCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.SwipedCommandProperty = AppoMobi.Touch.GestureHandler.SwipedCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.SwipedCommandParameterProperty = AppoMobi.Touch.GestureHandler.SwipedCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.RotatingCommandProperty = AppoMobi.Touch.GestureHandler.RotatingCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.RotatingCommandParameterProperty = AppoMobi.Touch.GestureHandler.RotatingCommandParameterProperty;
			AppoMobi.Touch.LegacyGesturesContentView.RotatedCommandProperty = AppoMobi.Touch.GestureHandler.RotatedCommandProperty;
			AppoMobi.Touch.LegacyGesturesContentView.RotatedCommandParameterProperty = AppoMobi.Touch.GestureHandler.RotatedCommandParameterProperty;
		}
