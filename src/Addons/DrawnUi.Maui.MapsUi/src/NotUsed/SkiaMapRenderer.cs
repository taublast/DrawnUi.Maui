...
public class SkiaMapRenderer : IRenderer
{
    ...
    private void Render(SKCanvas canvas, Viewport viewport, IEnumerable<ILayer> layers)
    {
        try
        {
            ...
            VisibleFeatureIterator.IterateLayers(viewport, layers, _currentIteration, (v, l, s, f, o, i)
                =>
            { RenderFeature(canvas, v, l, s, f, o, i); });
